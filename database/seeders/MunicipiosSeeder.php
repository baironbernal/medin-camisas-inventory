...
class MunicipiosSeeder extends Seeder
{
    ...
    {
        // Agrupamos los municipios por código de departamento.
        // La clave del array es el código DANE del departamento.
        $municipiosPorDepartamento = [
            '05' => [ // Antioquia
                ...
                ['codigo' => '05245', 'nombre' => 'El Bagre'],
                ['codigo' => '05250', 'nombre' => 'Entrerríos'],
                ['codigo' => '05264', 'nombre' => 'Envigado'],
                ['codigo' => '05266', 'nombre' => 'Fredonia'],
                ['codigo' => '05282', 'nombre' => 'Frontino'],
                ...
                ['codigo' => '05789', 'nombre' => 'Tarazá'],
                ['codigo' => '05790', 'nombre' => 'Tarso'],
                ['codigo' => '05792', 'nombre' => 'Titiribí'],
                ['codigo' => '05809', 'nombre' => 'Toledo'],
                ['codigo' => '05819', 'nombre' => 'Turbo'],
                ['codigo' => '05837', 'nombre' => 'Uramita'],
                ['codigo' => '05842', 'nombre' => 'Urrao'],
                ['codigo' => '05847', 'nombre' => 'Valdivia'],
                ['codigo' => '05854', 'nombre' => 'Valparaíso'],
                ['codigo' => '05856', 'nombre' => 'Vegachí'],
                ['codigo' => '05858', 'nombre' => 'Venecia'],
                ['codigo' => '05861', 'nombre' => 'Vigía del Fuerte'],
                ['codigo' => '05873', 'nombre' => 'Yalí'],
                ['codigo' => '05875', 'nombre' => 'Yarumal'],
                ['codigo' => '05877', 'nombre' => 'Yolombó'],
                ['codigo' => '05879', 'nombre' => 'Yondó'],
                ['codigo' => '05885', 'nombre' => 'Zaragoza'],
            ],
            '08' => [ // Atlántico
            ...
            '13' => [ // Bolívar
                ...
                ['codigo' => '13460', 'nombre' => 'Mompós'],
                ['codigo' => '13468', 'nombre' => 'Morales'],
                ['codigo' => '13473', 'nombre' => 'Norosí'],
                ['codigo' => '13490', 'nombre' => 'Pinillos'],
                ['codigo' => '13549', 'nombre' => 'Regidor'],
                ['codigo' => '13580', 'nombre' => 'Río Viejo'],
                ['codigo' => '13600', 'nombre' => 'San Cristóbal'],
                ['codigo' => '13610', 'nombre' => 'San Estanislao'],
                ['codigo' => '13620', 'nombre' => 'San Fernando'],
                ['codigo' => '13647', 'nombre' => 'San Jacinto'],
                ['codigo' => '13650', 'nombre' => 'San Jacinto del Cauca'],
                ['codigo' => '13654', 'nombre' => 'San Juan Nepomuceno'],
                ['codigo' => '13655', 'nombre' => 'San Martín de Loba'],
                ['codigo' => '13657', 'nombre' => 'San Pablo'],
                ['codigo' => '13667', 'nombre' => 'Santa Catalina'],
                ['codigo' => '13670', 'nombre' => 'Santa Rosa'],
                ['codigo' => '13673', 'nombre' => 'Santa Rosa del Sur'],
                ['codigo' => '13683', 'nombre' => 'Simití'],
                ['codigo' => '13688', 'nombre' => 'Soplaviento'],
                ['codigo' => '13744', 'nombre' => 'Talaigua Nuevo'],
                ['codigo' => '13760', 'nombre' => 'Tiquisio'],
                ['codigo' => '13780', 'nombre' => 'Turbaco'],
                ['codigo' => '13787', 'nombre' => 'Turbaná'],
                ['codigo' => '13810', 'nombre' => 'Villanueva'],
                ['codigo' => '13836', 'nombre' => 'Zambrano'],
            ],
            '15' => [ // Boyacá
                ...
                ['codigo' => '15380', 'nombre' => 'La Victoria'],
                ['codigo' => '15401', 'nombre' => 'La Uvita'],
                ['codigo' => '15403', 'nombre' => 'Villa de Leyva'],
                ['codigo' => '15407', 'nombre' => 'Labranzagrande'],
            ...
            '25' => [ // Cundinamarca
                ...
                ['codigo' => '25513', 'nombre' => 'Venecia'],
                ['codigo' => '25518', 'nombre' => 'Pacho'],
                ['codigo' => '25524', 'nombre' => 'Paime'],
                ['codigo' => '25530', 'nombre' => 'Pandi'],
                ['codigo' => '25535', 'nombre' => 'Paratebueno'],
                ['codigo' => '25537', 'nombre' => 'Pasca'],
            ...
            '54' => [ // Norte de Santander
                ...
                ['codigo' => '54874', 'nombre' => 'Villa Caro'],
                ['codigo' => '54905', 'nombre' => 'Villa del Rosario'],
            ],
            '63' => [ // Quindío
            ...
            '70' => [ // Sucre
                ...
                ['codigo' => '70400', 'nombre' => 'Guaranda'],
                ['codigo' => '70418', 'nombre' => 'La Unión'],
                ['codigo' => '70429', 'nombre' => 'Los Palmitos'],
                ['codigo' => '70473', 'nombre' => 'Majagual'],
                ['codigo' => '70508', 'nombre' => 'Morroa'],
                ['codigo' => '70523', 'nombre' => 'Ovejas'],
                ['codigo' => '70533', 'nombre' => 'Palmito'],
                ...
                ['codigo' => '70771', 'nombre' => 'Since'],
                ['codigo' => '70820', 'nombre' => 'Sucre'],
                ['codigo' => '70823', 'nombre' => 'Tolú'],
                ['codigo' => '70828', 'nombre' => 'Tolú Viejo'],
            ],
            '73' => [ // Tolima
        ...
        // Insertamos los municipios departamento por departamento.
        // Para cada departamento buscamos su ID en la base de datos
        // y luego hacemos un insert masivo de sus municipios.
        foreach ($municipiosPorDepartamento as $codigoDep => $municipios) {
            $departamento = Departamento::where('codigo', $codigoDep)->first();

            if (!$departamento) {
                continue; // Si no existe el departamento, saltamos
            }

            // Agregamos el departamento_id a cada municipio antes de insertar
            $municipiosConDep = array_map(function ($municipio) use ($departamento) {
                return array_merge($municipio, ['departamento_id' => $departamento->id]);
            }, $municipios);

            Municipio::insert($municipiosConDep);
        }
    }
}
